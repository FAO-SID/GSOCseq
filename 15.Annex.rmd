...
The product *ISO_GSOCseq_T0_Map030* refers to the SOC stocks 0-30 cm in t/ha used as input in the Forward phase. This map should not significantly differ from the national FAO GSOCmap.
...
*   Check if extreme values (values > +80 and values < -80) are grouped or dispersed (refert to Annex I)
...
*   There should not be negative values other than -999 
*   Maximum values should usually not exceed +80
*   Check if extreme values (values > +80) are grouped or dispersed (refert to Annex I)
...
*   Check if extreme values (> +4; <-4) are grouped or dispersed (refert to Annex I)
...
*   RSR BAU: most values range from 0 to + 0.5, with median values near 0 or lower
...
*   Check if extreme values (>200 % and <0 %) are grouped or dispersed (refert to Annex I)
