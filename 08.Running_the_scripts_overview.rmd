...
![*Workflow for generating the national GSOCseq layers.*](images/Figure_8.1.png)
...
kable(booktabs = T, dt, col.names = gsub("[.]", " ", names(dt)), caption = 'Summary of the scripts for the complete modelling process.',
