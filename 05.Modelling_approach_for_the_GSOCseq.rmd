...
Where $\gamma$ are the partition coefficients of the incoming carbon inputs as explained in equation 5.3, and $u$ coefficients are the result of functions integrating model structure and parametrization of RothC, following the equations in the supplementary material of Dechow et el. (2019). 
