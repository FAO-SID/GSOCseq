...
kable(booktabs = T, dt, col.names = gsub("[.]", " ", names(dt)),
caption = 'Required R-packages for the national SOC sequestration potential maps using an R-environment.',
...
![*Overview of RStudio's windowpanes and functionalities*](images/Figure_7.1.png)  
